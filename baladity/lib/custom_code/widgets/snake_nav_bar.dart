...
class ExampleApp extends StatefulWidget {
  ...
  @override
  State<ExampleApp> createState() => _SnakeNavigationBarState();
}

class _SnakeNavigationBarState extends State<ExampleApp> {
  @override
    ...
    return Scaffold(
      ...
      bottomNavigationBar: SnakeNavigationBar.color(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.add), label: 'microphone'),
