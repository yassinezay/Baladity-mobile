...
import 'list_reclamation_recherche_model.dart';
export 'list_reclamation_recherche_model.dart';

class ListReclamationRechercheWidget extends StatefulWidget {
  const ListReclamationRechercheWidget({
    super.key,
    this.search,
  });
  ...
  @override
  State<ListReclamationRechercheWidget> createState() =>
      _ListReclamationRechercheWidgetState();
}

class _ListReclamationRechercheWidgetState
    extends State<ListReclamationRechercheWidget> {
  late ListReclamationRechercheModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListReclamationRechercheModel());
                ...
                children: [
                  ...
                  StreamBuilder<List<ReclamationRecord>>(
                    stream: queryReclamationRecord(
                      queryBuilder: (reclamationRecord) => reclamationRecord
                          .where(
                            'id_user',
